...
import com.tang.parser.objectbuilder.*;
import com.tang.parser.objectbuilder.helper.TargetPageAnalyzer;
import com.tang.preparser.PreParserLog;
import com.tang.preparser.WebLogPreParser;
...
public class LogParserTest {
    ...
    @Test
    public void parse() {
        List<PreParserLog> preParsedLogs = new ArrayList<>();
        ...
        preParsedLogs.add(WebLogPreParser.parser(hbStr));
        ...
        preParsedLogs.add(WebLogPreParser.parser(evStr));
        ...
        preParsedLogs.add(WebLogPreParser.parser(mcStr));
        String pvStr = "2018-06-15 18:43:27 10.200.200.98 GET /gs.gif " +
                ...
                "80 - 58.210.35.226 Mozilla/5.0+(Windows+NT+10.0;+Win64;+x64)+AppleWebKit/537.36+(KHTML,+like+Gecko)+Chrome/67.0.3396.87+Safari/537.36";
        preParsedLogs.add(WebLogPreParser.parser(pvStr));
